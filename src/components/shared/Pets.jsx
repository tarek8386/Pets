...
const Pets = ({data}) => {
  ...
  return (
   <>
          <div
            className="petsItem p-2 md:p-3 lg:p-4 rounded-[20.885px] border-[0.653px] border-[solid] border-[#E8E8E8] bg-[#FFF] [box-shadow:2px_4px_20px_0px_rgba(0,_0,_0,_0.12)] flex flex-col gap-[15px] md:gap-[20px] lg:gap-[26.11px]"
          >
            ...
            <div className="flex flex-col gap-[8px] md:gap-[10px] lg:gap-[26px]">
              ...
              <div className="flex flex-col gap-[10px] md:gap-[12px] lg:gap-[15px] xl:gap-[20px]">
              <h3 className="text-[#2F2F2F] font-noto text-[20px] not-italic font-semibold leading-[26.4px] tracking-[-0.4px]">
                {data.title}
              </h3>
              <div className="details flex flex-col gap-[5px] md:gap-[8px]">
                <p className='text-[#757575]  font-nunito text-[16px] not-italic font-normal leading-[100%]'>{data.type}</p>
                <p className='font-nunito text-[14px] not-italic font-normal leading-[100%] text-[#757575] '>{data.age} year-old</p>
              </div>
              </div>
              <button className="text-[#FFF] font-nunito text-[16px] not-italic font-bold leading-[164%] flex w-full px-[24px] py-[6px] md:py-[8px] lg:py-[10px] justify-center items-center gap-[6.526px] rounded-[99px] bg-[linear-gradient(91deg,_#FF9F2C_0%,_#EA8A00_100%)] [box-shadow:0px_4px_7px_0px_rgba(254,_143,_8,_0.20)] mx-auto">Meet Me</button>
            </div>
          </div>
   </>
  )
